...
def demo_archetype_influence():
    ...
    for archetype in archetypes:
        ...
        try:
            ...
            context = engine.generate_behavioral_context(state, style=ContextStyle.CONCISE)
            blank(1)
...
def demo_comparison_old_vs_new():
    ...
    factory = PersonalityStateFactory.from_default_resources()
    state = factory.from_adjectives("comparison-demo", ["organized", "thorough", "careful"])
...
Structure your answer clearly."""
    ...
    say_model("  • New: Authentic expressions from WordNet/Goldberg psychology resources")
...
def main():
    ...
    blank(1)
    say_system("╔══════════════════════════════════════════════════════════════════════╗")
    say_system("║           RnB Gloss-Based Influence System Demonstration             ║")
    say_system("╚══════════════════════════════════════════════════════════════════════╝")
    blank(1)
    ...
    say_system("behavioral expressions derived from the RnB WordNet/Goldberg resources,")
