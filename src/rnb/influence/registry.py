...
class OperatorRegistry:
    ...
    def register(
        ...
        custom_activation: Callable[[InfluenceContext], bool] | None = None,
    ) -> None:
        """
    ...
    def get_operator(self, name: str) -> InfluenceOperator | None:
        """
    ...
    def list_operators(
        self, category: str | None = None, include_inactive: bool = True
    ...
    def _check_activation(
        self, operator: InfluenceOperator, context: InfluenceContext
    ) -> bool:
        """
    ...
    def get_active_operators(
        self, context: InfluenceContext, category: str | None = None
    ) -> list[InfluenceOperator]:
        """
        ...
        active = [op for op in candidates if self._check_activation(op, context)]
