...
from .state import PersonalityState, MoodDimension, AffectDimension
from .taxonomy import Taxonomy, Trait, FACETS_BY_TRAIT, normalize_trait, normalize_facet
from ..resources import PersonalityResolver, PersonalitySpecification
...
class ArchetypeRegistry:
    ...
    def get(self, name: str) -> Optional[ArchetypeDefinition]:
...
class PersonalityStateFactory:
    ...
    def __init__(
        ...
        taxonomy: Taxonomy,
        archetypes: Optional[ArchetypeRegistry] = None
    ):
        """
    ...
    def from_default_resources(cls) -> "PersonalityStateFactory":
        ...
        """
        from ..resources import PersonalityResolver, SchemeRegistry
        ...
        return cls(resolver, taxonomy, archetypes)
    ...
    def from_adjectives(
        ...
        return self.from_specification(
            agent_id, 
            spec,
    ...
    def from_specification(
        ...
        state = PersonalityState(
            agent_id=agent_id,
            source_adjectives=spec.input_adjectives
        )
    ...
    def from_schemes(
        ...
        source_adjectives: Optional[list[str]] = None
    ) -> PersonalityState:
        """
    ...
    def from_mixed(
        self,
        agent_id: str,
        traits: Optional[dict[Trait | str, float]] = None,
        facets: Optional[dict[str, float]] = None,
        schemes: Optional[dict[str, float]] = None,
        ...
        if traits:
            for trait_input, value in traits.items():
                trait = trait_input if isinstance(trait_input, Trait) else normalize_trait(trait_input)
                if trait is None:
                    continue
    ...
    def create_from_archetype(
        ...
        return self.from_traits(
            agent_id=agent_id,
            traits=traits,
            source_adjectives=archetype_def.adjectives
        )
