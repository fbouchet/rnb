...
class PersonalityStateStore:
    ...
    def __init__(self, backend: Optional[RedisBackend] = None):
        """
    ...
    def get_state(self, agent_id: str) -> Optional[PersonalityState]:
        """
    ...
    def update_affect(self, agent_id: str, changes: dict[AffectDimension, float]) -> None:
        """
