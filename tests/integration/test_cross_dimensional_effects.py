...
from rnb.influence.trait_based import EnthusiasmInfluence, StructureInfluence
...
class TestTraitAffectInteraction:
    ...
    def test_conscientiousness_and_cooperation_combine(
        ...
        response_minimal = llm_client.query(
            prompt_minimal, temperature=0.7, max_tokens=500
        )
...
class TestTraitMoodInteraction:
    ...
    def test_extraversion_and_energy_combine(
        ...
        assert (
            words_energetic > words_tired * 0.8
