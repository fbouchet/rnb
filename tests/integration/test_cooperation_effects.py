...
class TestCooperationVerbosity:
    ...
    def test_cooperation_affects_verbosity(
        ...
        agent_manager.create_agent(
            "high_coop", affects={AffectDimension.COOPERATION: 0.9}
        )

        agent_manager.create_agent(
            "low_coop", affects={AffectDimension.COOPERATION: -0.5}
        )
...
class TestCooperationHelpfulness:
    ...
    def test_cooperation_affects_helpfulness(
        ...
        # Create agents
        agent_manager.create_agent(
            "helpful_agent", affects={AffectDimension.COOPERATION: 0.8}
        )

        agent_manager.create_agent(
            "minimal_agent", affects={AffectDimension.COOPERATION: -0.4}
        )
