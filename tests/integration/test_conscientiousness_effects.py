...
class TestConscientiousnessVerbosity:
    ...
    def test_high_conscientiousness_produces_longer_responses(
        ...
        _high_c = agent_manager.create_agent(
            "high_c_agent", traits={FFMTrait.CONSCIENTIOUSNESS: 0.8}
        )

        # Create low conscientiousness agent
        _low_c = agent_manager.create_agent(
            "low_c_agent", traits={FFMTrait.CONSCIENTIOUSNESS: -0.8}
        )
    ...
    def test_conscientiousness_affects_structure(
        ...
        agent_manager.create_agent(
            "structured_agent", traits={FFMTrait.CONSCIENTIOUSNESS: 0.8}
        )

        agent_manager.create_agent(
            "unstructured_agent", traits={FFMTrait.CONSCIENTIOUSNESS: -0.8}
        )
        ...
        assert (
            has_structure_high or not has_structure_low
...
class TestConscientiousnessMultipleOperators:
    ...
    def test_combined_conscientiousness_effects(
        ...
        agent_manager.create_agent(
            "very_conscientious", traits={FFMTrait.CONSCIENTIOUSNESS: 0.85}
        )
