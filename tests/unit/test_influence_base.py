...
from rnb.influence.base import CompositeInfluenceOperator, InfluenceOperator
from rnb.influence.context import InfluenceContext
from rnb.personality.state import AffectDimension, FFMTrait, PersonalityState
...
class HighPriorityOperator(InfluenceOperator):
    ...
    def __init__(self):
        super().__init__(
            name="high_priority", description="High priority operator", category="test"
        )
...
class LowPriorityOperator(InfluenceOperator):
    ...
    def __init__(self):
        super().__init__(
            name="low_priority", description="Low priority operator", category="test"
        )
...
def test_composite_apply_chains_operators(sample_context):
    ...
    composite = CompositeInfluenceOperator(
        name="test_composite", description="Test composite", operators=[op1, op2]
    )
...
def test_composite_empty_operators_list(sample_context):
    ...
    composite = CompositeInfluenceOperator(
        name="empty_composite", description="Empty composite", operators=[]
    )
