...
class MockOperatorAlpha(InfluenceOperator):
    ...
    def __init__(self):
        super().__init__(
            name="alpha", description="Always active test operator", category="test"
        )
...
class MockOperatorGamma(InfluenceOperator):
    ...
    def __init__(self):
        super().__init__(
            name="gamma", description="Different category operator", category="other"
        )
...
class MockOperatorNever(InfluenceOperator):
    ...
    def __init__(self):
        super().__init__(name="never", description="Never active", category="test")
...
def test_get_active_operators_by_category(registry, high_extraversion_context):
    ...
    active_test = registry.get_active_operators(
        high_extraversion_context, category="test"
    )
