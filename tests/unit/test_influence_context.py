...
def test_has_user_context_true():
    ...
    context = InfluenceContext(personality=state, user_context={"data": "value"})
...
def test_has_session_context_true():
    ...
    state = PersonalityState(agent_id="test")
    context = InfluenceContext(personality=state, session_context={"turn": 1})
...
def test_has_task_context_true():
    ...
    state = PersonalityState(agent_id="test")
    context = InfluenceContext(personality=state, task_context={"domain": "math"})
